...
void spi_core_enable();
void spi_core_disable();
void spi_core_interrupt_enable();
void spi_core_interrupt_disable();
void spi_core_interrupt_flag_clear();
void spi_core_clock_setup( char polarity, char phase, char rate,char ext_rate);
void spi_core_set_int_count( char cnt);
void spi_core_slave_select( char slave_sel_dec);
void spi_core_write_data( char data);
int spi_core_data_avail();
int spi_core_write_avail();
char spi_core_read_data();
