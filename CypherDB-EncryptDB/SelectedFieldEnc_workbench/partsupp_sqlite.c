...
{
  char *partSuppTable = "create table PartSupp(ps_partkey INTEGER, ps_suppkey INTEGER, ps_availqty INTEGER, ps_supplycost REAL, ps_comment CHAR(199), ps_partkeyOPE INTEGER, ps_suppkeyOPE INTEGER);";
