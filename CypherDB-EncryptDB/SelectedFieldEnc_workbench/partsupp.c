...
void toPartSuppOTP(partSupp *partSuppPt, partSuppOTP *partSuppOTPPt)
{
  ...
  /* OPE transfer */
  partSuppOTPPt->partKeyOPE = partSuppPt->partKeyOPE;
  partSuppOTPPt->suppKeyOPE = partSuppPt->suppKeyOPE;
}
...
readPartSupp(partSupp* partSuppPt, FILE* ifp)
{
  ...
  /* read OPE value */
  readllong(&(partSuppPt->partKeyOPE), ifp);
  readllong(&(partSuppPt->suppKeyOPE), ifp);
}
...
void decryptPartSupp(partSuppOTP *partSuppOTPPt, partSuppOTP *partSuppDecPt, partSupp *sizePt, const AES_KEY *aes, unsigned char cntr[AES_BLOCK_SIZE])
{
  ...
  /* OPE value direct copy, no decryption */
  partSuppDecPt->partKeyOPE = partSuppOTPPt->partKeyOPE;
  partSuppDecPt->suppKeyOPE = partSuppOTPPt->suppKeyOPE;
}
...
void printPartSupp(partSupp *partSuppPt, FILE * ifp)
{
  ...
  /* print OPE value */
  printllong(ifp, partSuppPt->partKeyOPE, "|");
  printllong(ifp, partSuppPt->suppKeyOPE, "|");
  fprintf(ifp, "\n");
}
