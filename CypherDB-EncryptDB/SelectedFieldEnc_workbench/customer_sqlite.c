...
{
  char *customerTable = "create table Customer(c_custkey INTEGER, c_name CHAR(25), c_address CHAR(40), c_nationkey INTEGER, c_phone CHAR(15), c_acctbal REAL,c_mktsegment CHAR(10),c_comment CHAR(117), c_custkeyOPE INTEGER, c_nationkeyOPE INTEGER);";
