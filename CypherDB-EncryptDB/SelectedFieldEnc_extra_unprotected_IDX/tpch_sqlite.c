...
void *tpchInputTemplate(char *directory, char *fileName, int numOfTable, int *pagePerTable)
{
  ...
  // create index
  fprintf(stdout, "create index PartPKI on Part(p_partkeyIDX); \n create index SupplierPK on Supplier(s_suppkeyIDX); \n create index PartSuppPKI on PartSupp(ps_partkeyIDX, ps_suppkeyIDX); \n create index CustomerPKI on Customer(c_custkeyIDX); \n create index NationPKI on Nation(n_nationkeyIDX); \n create index RegionPKI on Region(r_regionkeyIDX); \n create index LineItemPKI on LineItem(l_orderkeyIDX); \n create index OrdersPKI on Orders(o_orderkeyIDX); \n create index SupplierNations on Supplier(s_nationkeyIDX); \n create index CustomerNations on Customer(c_nationkeyIDX); \n create index LineItemSuppliers on LineItem(l_suppkeyIDX); \n create index OrderCustomers on Orders(o_custKeyIDX); \n create index PartSuppSupp on PartSupp(ps_suppkeyIDX); \n create index LineItemParts on LineItem(l_partkeyIDX); \n");
