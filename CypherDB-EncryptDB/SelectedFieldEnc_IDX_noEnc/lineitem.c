...
void item_free(lineitem *itemPt)
{
...
//	itemOPTPt->OrderKey = BytesFromIntCount(sizePt->OrderKey, SerialType(sizePt->OrderKey));
//	itemOPTPt->PartKey = BytesFromIntCount(sizePt->PartKey, SerialType(sizePt->OrderKey));	
//	itemOPTPt->SuppKey = BytesFromIntCount(sizePt->SuppKey, SerialType(sizePt->OrderKey));		
