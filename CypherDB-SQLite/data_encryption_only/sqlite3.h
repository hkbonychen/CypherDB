...
//#ifdef 100MB
	#define tb1MAX 600572
	#define tb2MAX 150000
	#define tb3MAX 20000
	#define tb4MAX 15000
	#define tb5MAX 1000
	#define tb6MAX 80000
...
//#ifdef 500MB
/*	#define tb1MAX 2999671
	#define tb2MAX 750000
	#define tb3MAX 100000
	#define tb4MAX 75000
	#define tb5MAX 5000
	#define tb6MAX 400000
	#define tb7MAX 25
	#define tb8MAX 5
*/
//#endif
...
//#ifdef 1GB
/*	#define tb1MAX 6001215
	#define tb2MAX 1500000
	#define tb3MAX 200000
	#define tb4MAX 150000
	#define tb5MAX 10000
	#define tb6MAX 800000
	#define tb7MAX 25
	#define tb8MAX 5
*/
//#endif
...
typedef int (*sqlite3_sCallback)(void*,int,char**, char**, int ,int *);
...
int sqlite3_sExec(
  sqlite3*,                                  /* An open database */
  const char *sql,                           /* SQL to be evaluated */
  int (*callback)(void*,int,char**,char**, int, int*),  /* Callback function */
  void *,                                    /* 1st argument to callback */
  char **errmsg                              /* Error msg written here */
);
